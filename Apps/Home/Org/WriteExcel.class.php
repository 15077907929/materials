...
//        exit;
	...
	public function setBorder($cell , $border_color = null,$value)
	{
        $objStyleS = $this->sheet->getStyle($cell);
        $objBorder = $objStyleS->getBorders();

        if($value == 1 ){
            $objBorder->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
            $objBorder->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
            $objBorder->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
            $objBorder->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_NONE);
        }else{
