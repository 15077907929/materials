...
$conf1 = array(
    ...
    'SEARCHKEYWORDTYPE' => array('首绑' => '1', '切换国家' => '2', '找回账号' => '3', '授权恢复' => '5', '只打开指定APP' => '7', '刷评论' => '10', '注册绑定' => '9', '临时任务类型' => '20'),
    ...
    'NAVIGATION' => array(
        ...
        '任务管理' => array(
            ...
            '评论组任务管理' => array(
                'link' => '/Task2/taskManager',
                'power' => 'GTASKS,GTASKO,GTASKO1',
                'parent' => '协议任务管理',
            ),
            '评论单条任务查看' => array(
                'link' => '/Task2/oneTaskManager',
                'power' => 'OTMS',
                'parent' => '协议任务管理',
            ),
            '协议计划评估' => array(
...
//            ),
        ...
        '数据分析' => array(
			...
			'赵宁组图' => array(
                'link' =>  '/Total2/zhaoning?sub_where=nocomment',
                'power' => 'plzn'
            ),	
			'评论赵宁组图' => array(
                'link' =>  '/Total2/zhaoning?sub_where=comment',
                'power' => 'plzn'
            ),			
			'成功数图' => array(
