...
var task_item_tpl = '<li class="cmf-component-tabitem">' +
    ...
    '<span class="cmf-component-tabclose" href="javascript:void(0)" title="鐐瑰嚮鍏抽棴鏍囩"><span></span><b class="cmf-component-tabclose-icon">脳</b></span>' +
    '</li>';
...
function openapp(url, appId, appname, refresh) {
    ...
    //url瑕佹坊鍔犲弬鏁般€傝幏鍙栨渶澶栭儴鐨剋indow.淇敼href
    // 鏀寔History API
    ...
    var contentWidth     = $("#task-content").width();
    if (taskContentInner <= contentWidth) { //濡傛灉娌℃湁寮€濮嬫粴鍔ㄥ氨涓嶇敤杩涜涓嬪幓浜�
        return;
    }
