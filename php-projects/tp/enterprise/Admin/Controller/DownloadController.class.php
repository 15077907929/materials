		...
		switch ($method) {
            ...
            case 'add':
				if($_POST){
					...
					$data['downloadurl']=$_POST['downloadurl'];
					...
					if($db2->add($data)){
						echo '<script type="text/javascript"> alert("操作成功"); location.href="index.php?m=Admin&c=Download&a=download&class1='.$_POST['class1'].'"; </script>';
					}	
				}
