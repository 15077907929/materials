		...
		switch ($method) {
            ...
            case 'add':
				if($_POST){
					...
					$data['messageurl']=$_POST['messageurl'];
					$data['messageurls']=$_POST['messageurls'];
					$data['message_ok']=intval($_POST['message_ok']);
					...
					if($db2->add($data)){
						echo '<script type="text/javascript"> alert("操作成功"); location.href="index.php?m=Admin&c=message&a=message&class1='.$_POST['class1'].'"; </script>';
					}	
				}
