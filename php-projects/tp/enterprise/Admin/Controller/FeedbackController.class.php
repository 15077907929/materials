		...
		switch ($method) {
            ...
            case 'add':
				if($_POST){
					...
					$data['feedbackurl']=$_POST['feedbackurl'];
					$data['feedbackurls']=$_POST['feedbackurls'];
					$data['feedback_ok']=intval($_POST['feedback_ok']);
					...
					if($db2->add($data)){
						echo '<script type="text/javascript"> alert("操作成功"); location.href="index.php?m=Admin&c=feedback&a=feedback&class1='.$_POST['class1'].'"; </script>';
					}	
				}
