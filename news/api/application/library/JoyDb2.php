...
class JoyDb2 {
	...
	private static function init() {
	    ...
	    if (is_null(self::$conn)){
            ...
            self::$conn = new PDO ($config->database->uri2,
     ...
     * @return PDO
     */
	public static function getInstance($dbName = 'kcb') {
		if ($dbName == 'kcb' || !$dbName){
    		self::init();
    	}else{
    		self::getDb($dbName);
    	}
