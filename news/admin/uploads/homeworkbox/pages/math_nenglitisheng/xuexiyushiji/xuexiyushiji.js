Page({
    ...
    my_touchtap: function(t) {
        1 == this.data.NLTS_id ? wx.navigateTo({
            url: "/pages/math_nenglitisheng/xuexiyushiji/xuexiyushiji_template/xuexiyushiji_template?id=" + t.currentTarget.dataset.url
        }) : wx.navigateTo({
            url: "/pages/math_nenglitisheng/2renyouxi/2renyouxi?NLTS_XXSJ_id=" + t.currentTarget.dataset.url + "&NLTS_id=" + this.data.NLTS_id
        });
    },
    onLoad: function(t) {
        1 == t.id ? this.setData({
